...
import DataEntryModal from "../../components/dataentrydoctor";
...
export default function Doctor() {
  ...
  const handleDelete = (id) => {
    axios
      .post("http://localhost:5000/delete-data", { id })
      .then((res) => {
        if (res.status === 200) {
  ...
  const handleSubmit = (data) => {
    ...
    if (currentRow) {
      ...
      axios
        .post("http://localhost:5000/update-data", { id, data: payload })
        .then((res) => {
          if (res.status === 200) {
  ...
  const columns = [
    ...
    { field: "experience", headerName: "Years of Experience", width: 200 },
    {
      field: "actions",
      headerName: "Actions",
      width: 130,
